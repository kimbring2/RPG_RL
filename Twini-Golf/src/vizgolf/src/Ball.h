...
extern std::string ball_action;
extern bool swing_flag;
extern bool animation_flag;
extern bool next_level_flag;
...
public:
    ...
    void update(double deltaTime, bool mouseDown, bool mousePressed, std::vector<Tile> tiles, std::vector<Hole> holes, Mix_Chunk* chargeSfx, 
